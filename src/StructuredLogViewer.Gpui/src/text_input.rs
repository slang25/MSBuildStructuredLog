//! Single-line text field: gpui's `input` example, trimmed to what a search
//! box needs, plus change/submit events. IME, selection, clipboard and
//! caret all work because the element implements `EntityInputHandler`.
...
actions!(
    text_input,
    [Backspace, Delete, Left, Right, SelectLeft, SelectRight, SelectAll, Home, End, Paste, Cut, Copy, Submit, Clear]
);
...
pub fn key_bindings() -> Vec<gpui::KeyBinding> {
    ...
    vec![
        K::new("backspace", Backspace, c),
        K::new("delete", Delete, c),
        K::new("left", Left, c),
        K::new("right", Right, c),
        K::new("shift-left", SelectLeft, c),
        K::new("shift-right", SelectRight, c),
        ...
        K::new("home", Home, c),
        K::new("end", End, c),
        K::new("cmd-left", Home, c),
        K::new("cmd-right", End, c),
        K::new("enter", Submit, c),
        K::new("escape", Clear, c),
    ]
}
...
impl Render for TextInput {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .border_1()
            .border_color(if focused { theme.accent } else { theme.field_border })
            ...
            .child(TextElement {
                ...
                accent: theme.accent,
                selection: theme.accent.opacity(0.3),
            })
    }
}
